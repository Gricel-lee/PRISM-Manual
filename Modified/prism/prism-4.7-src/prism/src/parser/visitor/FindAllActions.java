...
public class FindAllActions extends ASTTraverseModify
{
	...
	public void visitPost(Command e) throws PrismLangException
	{
		...
		throw new PrismLangException("[1] Unknown action name " + e.getSynch() + " in command", e);
	}
	...
	public void visitPost(RewardStructItem e) throws PrismLangException
	{
		...
		else if (i == -1) { //Added by Gris>  
			// pass
			return;
		}
		// Otherwise, there is a problem.
		throw new PrismLangException("[2] Unknown action name " + e.getSynch() + " in reward structure item", e);
	}
}
